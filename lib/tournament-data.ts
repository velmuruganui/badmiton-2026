...
export const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    schedule: [
      { matchNo: 1, a: "A", b: "B", ref: "C" },
      { matchNo: 2, a: "B", b: "C", ref: "A" },
      { matchNo: 3, a: "C", b: "A", ref: "B" },
    ],
  },
  {
    slug: "kids-u11",
  ...
  },
  {
    ...
    color: "#ec4899",
    teams: [
      { code: "Prema", players: ["Prema"] },
      { code: "Reena", players: ["Reena"] },
      { code: "Durga", players: ["Durga"] },
      { code: "Vidya", players: ["Vidya"] },
      { code: "Sanjana", players: ["Sanjana"] },
    ],
    // No fixture was provided on the sheet; inferred as a singles round-robin.
    note: "Schedule inferred as a 5-player singles round-robin (not on the original sheet).",
    schedule: [
      { matchNo: 1, a: "Prema", b: "Reena" },
      { matchNo: 2, a: "Durga", b: "Vidya" },
      { matchNo: 3, a: "Sanjana", b: "Prema" },
      { matchNo: 4, a: "Reena", b: "Durga" },
      { matchNo: 5, a: "Vidya", b: "Sanjana" },
      { matchNo: 6, a: "Prema", b: "Durga" },
      { matchNo: 7, a: "Reena", b: "Vidya" },
      { matchNo: 8, a: "Prema", b: "Vidya" },
      { matchNo: 9, a: "Reena", b: "Sanjana" },
      { matchNo: 10, a: "Durga", b: "Sanjana" },
    ],
  },
];
